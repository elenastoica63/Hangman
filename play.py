...
def choose_word(choice):
    if choice == "easy":
        ...
        secretWord = random.choice(word_list1)
    elif choice == "hard":
        secretWord = random.choice(word_list2)
